...
$source = Join-Path $root "tray\Program.cs"
...
& $compiler /nologo /target:winexe /platform:anycpu /optimize+ /debug- `
  ...
  /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll $source
